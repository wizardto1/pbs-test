...
note9="-";
  ...
  ngOnInit() {
    ...
    this.score3=this.scoresService.get3Value();
    this.score4=this.scoresService.get4Value();
    this.score5=this.scoresService.get5Value();
    this.score6=this.scoresService.get6Value();
    this.score7=this.scoresService.get7Value();
    this.score8=this.scoresService.get8Value();
    this.score9=this.scoresService.get9Value();
    this.score10=this.scoresService.get10Value();
    this.score11=this.scoresService.get11Value();
